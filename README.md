...
- `APPROVE_MIN_APPROVAL_ROLE` - Минимальная роль, одобрение которой учитывает утилита. Возможны следующие значения:
  ...
  - Reporter      = 20
  - Developer     = 30
  - Maintainer    = 40 # Значение по умолчанию.
  - Owner         = 50
  - Admin         = 60
...
- `APPROVE_MIN_APPROVAL_COUNT` - Минимальное количество одобрений, которое необходимо получить, для согласования. Значение по умолчанию: 1.
